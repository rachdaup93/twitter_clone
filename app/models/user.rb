class User < ApplicationRecord
  ...
  has_many :followee_followships, foreign_key: :followee_id, class_name: "Followship";
  has_many :followees, through: :followee_followships, source: :followee

  has_many :follower_followships, foreign_key: :follower_id, class_name: "Followship";
